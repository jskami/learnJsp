...
<br>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Notice Insert</h1>
                    <p class="mb-4"></p>
                    ...
                    <div class="card shadow mb-4">
						...
						<form method="post" action="/notice2/insert" class="user" enctype="multipart/form-data">
                           ...
                           <div class="form-group row">
                               <div class="col-sm-6 mb-3 mb-sm-0">
                               	   <label>작성자</label>
                                   <input type="text" class="form-control" name="n_name" placeholder="작성자" value="${a_id}" readonly>
                               </div>
                           </div>
                           <div class="form-group row">
                           		<div class="col-sm-6 mb-3 mb-sm-0">
                           ...
                           <div class="form-group row">
                               <div class="col-sm-6 mb-3 mb-sm-0">
                               	   <label>작성자</label>
                                   <input type="file" class="form-control" name="n_file" placeholder="첨부파일">
                               </div>
                           </div>
                           <div class="form-group row">
                               <div class="col-sm-6 mb-3 mb-sm-0">
