        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <a class="nav-icon position-relative text-decoration-none" href="/member2/view">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="/resources/img/banner_img_001.jpg" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>사전예약</b> PlayStation 5</h1>
                                <h3 class="h2">11차 사전예약 프로모션 진행중</h3>
                                <p>
                                    "Play Has No Limits" 4K 고화질 그래픽을 지원하기 위해 통합 CPU 및 GPU 기반의 동일한 커스텀 프로세서를 장착하고 빠른 로딩을 지원하는 통합
                                    I/O 기반의 초고속 SSD를 탑재한 9세대 콘솔 기기의 PS5는 듀얼센스 무선 컨트롤러와 3D 오디오 기능을 통해 깊은 몰입감을 제공합니다.<br>
                                    <a rel="sponsored" class="text-success" href="https://www.playstation.com/ko-kr/" target="_blank">공식 홈페이지</a>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="/resources/img/category_img_001.jpg" class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">PlayStation</h5>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="/resources/img/category_img_002.png" class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">Nintendo</h2>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="/resources/img/category_img_003.png" class="rounded-circle img-fluid border"></a>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="/resources/img/banner_img_004.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            ...
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark"><b>엘든 링</b></a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="/resources/img/banner_img_005.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                            ...
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark"><b>호라이즌 포비든 웨스트</b></a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="/resources/img/banner_img_006.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                            ...
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark"><h4>Nintendo Switch 소프트웨어 특집 「Nintendo Switch로 즐기는 퍼즐・트레이닝 소프트웨어」 추천</h4></a>
                            <p class="card-text">
